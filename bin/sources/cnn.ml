    ...
    |> List.iter (fun y ->
      ...
      then
        set_attribute
          ...
          y);
    List.iter (fun y -> delete_attribute y x) ["class"; "data-uri"; "data-editable"; "data-component-name"; "data-article-gutter"];
    if name x = "p"
    then to_string x
    else (
      ...
      then (
        ...
        List.iter
          ...
          [ "width"; "height"; "class"; "onload"; "onerror"; "height"; "width"; "loading" ];
